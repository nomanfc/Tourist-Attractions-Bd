...
public class CategoryDetailsAdapter extends RecyclerView.Adapter<CategoryDetailsAdapter.ViewHolder> {
    ...
    public CategoryDetailsAdapter(Context context, List<PlaceListModel> list) {
    ...
    public CategoryDetailsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CategoryDetailsAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.placelists,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryDetailsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
